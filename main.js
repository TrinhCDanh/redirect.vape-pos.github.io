    ...
    try {
        ...
        switch (platform) {
            case PLATFORM.ANDROID:
                window.location = 'https://twss-ohio-public-storage.s3.us-east-2.amazonaws.com/mobile-app/TWSSolutions_POS.apk'; // android download link
                break;
            case PLATFORM.IOS:
                window.location = 'itms-beta://beta.itunes.apple.com/v1/app/6466731003'; // ios download link
                break;
            default:
                break;
        }
